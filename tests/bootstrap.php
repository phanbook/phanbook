...
defined('APPLICATION_ENV') or define('APPLICATION_ENV', (getenv('APPLICATION_ENV') ? getenv('APPLICATION_ENV') : 'local'));

include ROOT_DIR . "/vendor/autoload.php";
include ROOT_DIR . '/common/config/loader.php';
include_once ROOT_DIR .'/common/View.php';
...
$di->set(
    ...
    function () {
        ...
        $cache = new Memcache($frontCache, array(
            "host" => "localhost",
            "port" => "11211"
        ));
