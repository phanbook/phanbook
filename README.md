...
- **Free and open.** Phanbook is released under the [GNU General Public License][:license:].
...
Licensed under the [GNU General Public License][:license:] Version 2.0 (or later);
