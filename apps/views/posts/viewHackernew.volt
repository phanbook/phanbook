...
<div id="main-content">
    <div id="question" class="tip question question-summary">
        ...
        <div class="question-title">
            <h2>
            <a href="{{object.getLink()}}" target="_blank" class="question-hyperlink">
                {{ object.getTitle() }}
                <span class="domain">{{object.getLink()}}</span>
            </a>
            </h2>
        </div>
        <div class="post-text">
        ...
        {% if postsReply|length > 0 %}
                <div class="count-post sort-wrap">
                    <div class="subheader">{{ postsReply|length }}|{{t('Discussions Hackernews!')}}</div>
                </div>
        ...
        <div class="post-answer answer-input-wrap">
            {{ form( 'replies/answer', 'role':'form') }}
                ...
                {# Not use for now#}
                {{ form.render('object', ['value': 'hackernews']) }}
            ...
            <h2 class="bottom-notice">
                ...
                {% endfor %} or <a href="/tips/create">make your own good link</a>
            </h2>
