{% extends 'layouts/layoutLogin.volt' %}
		...
		<div class="container">
			<div class="signup">
				...
				<div id="signup-form-1" style="display:none">
					{{ form('auth/signup', 'class' : 'signup-form')}}
			...
			<div class="login">
				<div class="regular-login">
					{{ form('auth/login', 'id': 'login-form', 'class': 'inline-login-form')}}
						...
						<div class="form-inputs">
							...
							<div class="form-column">
								...
								<div>
									<a class="forgot-password" href="/auth/forgotpassword">Forgot Password?</a>
								</div>
							</div>
