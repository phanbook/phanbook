...
class Parsedown
{
    ...
    /**
     * Linking @username mentions to user links
     *
     * @todo   fix
     * @param  @username
     * @return http:://you-website/@username
     */
    protected function blockMention($Line)
    {
        if (isset($Line['text']) && preg_match('/^@([^\s]+)/', $Line['text'], $matches)) {
            $Block = array(
